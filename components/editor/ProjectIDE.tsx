      ...
      <div className="lg:hidden border-b border-border bg-card px-3 py-2">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            ...
            <Button 
              variant={showCodeReview ? 'default' : 'ghost'} 
              size="sm" 
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="hidden lg:flex h-14 border-b border-border bg-card items-center justify-between px-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button 
              variant={showCodeReview ? 'default' : 'outline'} 
              size="sm" 
              onClick={() => setShowCodeReview(!showCodeReview)}
              title="AI-powered security and best practices review"
            >
              <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
